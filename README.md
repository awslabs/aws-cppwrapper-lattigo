...
This library provides partial C++ bindings for the [Lattigo v2.1.1](https://github.com/ldsec/lattigo/releases/tag/v2.1.1) Go-lang homomorphic encryption library. This wrapper does not attempt to provide a bindings for all public Lattigo APIs, but new bindings are quite easy to add and PRs are welcome.
